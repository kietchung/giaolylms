 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class news_viewed extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has viewed the news with the id '$this->objectid'.";
    }
    ...
    public static function get_legacy_eventname() {
        return 'local_newsvr_news_viewed';
    }
}