...
if (isloggedin()) {
    ...
    $templatecontext = array_merge($templatecontext, $themesettings->get_logo_news(), $themesettings->get_forums_trending_data(), $themesettings->get_forums_newestnews_data(), $themesettings->footer_items(), $themesettings->marketing_items());
